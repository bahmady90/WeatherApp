...
export default function DateButton({firstPart, dayAndMonths, handleSetWeatherDayIndex, index, weatherDayIndex}) {
  ...
  return (
    <button
        ...
        className={`${weatherDayIndex === index && " bg-gradient-to-r from-slate-300 to-slate-500 min-w-10 z-10 shadow-sm shadow-white"} border-black border-t-2 flex cursor-pointer min-w-8 flex-col basis-[30%] items-center rounded-xl bg-gray-100 text-base hover:text-xl `}>
